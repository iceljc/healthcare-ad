...
def getDistribution():
	...
	items = ["age", "yearOfEducation", "yearOfWork", "sex", "race", "hispanic"]
	
	attributes = {}
	attributes["age"] = ["<65", "65-84", ">=85"]
	attributes["yearOfEducation"] = ["<=12", "13-16", ">=17"]
	attributes["yearOfWork"] = ["<=12", "13-16", ">=17"]
	attributes["sex"] = ["Male", "Female"]
	attributes["race"] = ["White", "Black or African American", \
	...
	prob_attributes["yearOfWork"] = prob_attributes["yearOfEducation"]
	...
	prob_class_attributes["yearOfEducation"] = np.array([[0.17, 0.28, 0.27, 0.33],
														[0.43, 0.40, 0.40, 0.39], 
														[0.39, 0.31, 0.32, 0.27]])
	prob_class_attributes["yearOfWork"] = prob_class_attributes["yearOfEducation"]
...
def generateData(numOfData):
	...
	items_to_number = ["age", "yearOfEducation", "yearOfWork"]
	patients = []
